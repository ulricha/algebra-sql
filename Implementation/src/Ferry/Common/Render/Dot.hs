...
propsDot (Shape Oval)     = "shape=oval"
propsDot (Shape Triangle) = "shape=triangle"
propsDot (Color Red)      = "bgcolor=red"
propsDot (Color Blue)     = "bgcolor=blue"
propsDot (Color Green)    = "bgcolor=green"
propsDot (Color Yellow)   = "bgcolor=yellow"
propsDot (Color Black)    = "bgcolor=black"
propsDot (Color White)    = "bgcolor=white"
