module Ferry.Algabra.Data.Algebra where
...
type SemInfFunAggr  = (FunTyAggr, SemanticalInfosUNOP, Maybe PartitioningAttrName)
...
data Algebra where
    ...
    LitTable   :: SemInfLitTable -> SchemaInf -> Algebra
